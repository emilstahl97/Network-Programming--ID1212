...
public class HiLo extends AbstractGame implements Servable {
	...
	private int target;
	private int bank;
	private static final String GAME_NAME = "HiLo";
	...
	public void serve(BufferedReader input, PrintWriter output) throws IOException {
		output.println(
				"This is a game of Hi-Lo. You have six tries to correctly guess the value of the pot (1-100 dollars).");
		...
		if (this.getBestScore(GAME_NAME) == null || bank > this.getBestScore(GAME_NAME).getScore()) {
			output.println(bank + " is a new high score.  Please enter your initials...");
			String inits = input.readLine().trim();
			setBestScore(GAME_NAME, bank, inits);
		}
